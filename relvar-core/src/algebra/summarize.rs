...
impl Relation {
    ...
    /// # Errors
    ///
    /// - [`DatabaseError::AttributeNotFound`] - A grouping attribute
    ///   doesn't exist
    /// - [`DatabaseError::DuplicateAttributeName`] - An aggregation result name
    ///   conflicts with a grouping attribute
    /// - [`DatabaseError::AlgebraError`] - An aggregation failed (e.g.,
