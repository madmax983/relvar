//! Relational algebra delta operators for computing changes between relations.
//!
//! This module provides the [`crate::algebra::delta::Delta`] struct which represents the difference between
