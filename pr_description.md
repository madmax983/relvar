...
## ✨ Solution:
Extracted the inline logic from these large closures into private named helper functions (e.g., `calculate_intersection_distance`, `compute_force_component`, `compute_relu_activation`, etc.).
