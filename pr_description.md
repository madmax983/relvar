...
🧪 Example: Added 3 executable doctests. Also resolved visibility issues with internal modules breaking tests by adding #[doc(hidden)] and updating internal bench imports.
