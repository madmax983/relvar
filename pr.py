...
TITLE = "🌟 Nova: Relational Linear Regression"
DESCRIPTION = """💡 **The Spark**: Machine learning algorithms fundamentally rely on linear algebra and aggregation. Can we implement Gradient Descent directly inside the relational engine?
