...
## 2026-07-20 - Extract God Function in Importer
**Learning:** The from_csv function in relvar/src/tools/importer.rs was over 120 lines long, combining CSV line parsing, header validation, and row processing into a single large block.
**Action:** Applied the 'Three-Phase Operator' pattern by extracting header validation and row parsing into clean helper functions.
