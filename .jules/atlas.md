...
## 2024-05-19 - Fixing Public Module Leaks in Query Tests
**Tangle:** Broad visibility (`pub mod`) in `relvar-core/src/query/tests/mod.rs` leaked test implementation details, violating module encapsulation.
