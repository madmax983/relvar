...
## 2026-07-15 - The "Spreadsheet" Examples
**Confusion:** The experimental `Spreadsheet` had a placeholder example for the struct and its `evaluate` method, making it difficult to understand how to initialize the spreadsheet and resolve values.
**Clarification:** Replaced the placeholder and added comprehensive executable `/// # Examples` doc-tests for `Spreadsheet` to demonstrate how to construct the necessary relations and perform evaluation.
