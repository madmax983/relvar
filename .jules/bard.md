...
## 2025-05-19 - Documenting Spreadsheet
**Confusion:** The experimental `Spreadsheet` module had no executable doc-tests for the main struct and its methods (`new` and `evaluate`). This lack of examples made it confusing to understand how to initialize the values and formulas, and how to execute the evaluation step.
**Clarification:** Added executable `/// # Examples` doc-tests for `Spreadsheet` and its methods, demonstrating how to construct the necessary relations and perform cell formula resolution.
