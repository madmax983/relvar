...
## 2026-07-23 - The "Spreadsheet" Examples
**Confusion:** The experimental `Spreadsheet` module had placeholder examples and missing doc-tests for the main struct and its methods (`new` and `evaluate`). This made it confusing to understand how to initialize the cells, formulas, and execute the relational fixpoint evaluation.
**Clarification:** Added executable `/// # Examples` doc-tests for `Spreadsheet` and its methods, demonstrating how to construct the necessary values and formulas relations and perform spreadsheet evaluation.
