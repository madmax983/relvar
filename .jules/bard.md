...
**Confusion:** The experimental `Spreadsheet` had placeholder examples for `new` and `evaluate` and lacked an example for the struct itself. It was unclear how to represent cells and formulas relationally.
**Clarification:** Added executable `/// # Examples` doc-tests for `Spreadsheet` and its methods, demonstrating how to construct relations for values and formulas, and how they iteratively resolve.
