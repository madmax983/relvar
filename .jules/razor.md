...
**Cut:** Replaced the `MockRelation` struct and its methods with a single `generate_mock_relation` function.
**Saved:** ~40 lines of code and the cognitive load of a builder pattern for 3 parameters.
