...
## [Reduction]
**Bloat:** `relvar/src/experimental` module containing `automl`, `graph`, `image`, `mock`, `pivot`, `search`, `spatial`. These are speculative features not used by core.
**Cut:** Deleted the entire directory and the module declaration.
