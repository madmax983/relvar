...
## 2026-07-31 - [Tuple Accessors and Serde Coverage]
**Learning:** Verified Serde deserialization directly on `Arc` wrappers, and extracted tests for getters/accessors that improve basic struct and error enum coverage.
**Action:** Always include tests for standard error displays and custom deserialization proxies when implementing custom serde logic.
