...
## 2026-07-23 - ScalarValue Coverage
**Learning:** Certain nested user-defined types, bytes, and relational traits lacked `Hash` and `PartialOrd` coverage causing blindspots.
**Action:** Created dedicated coverage tests to interrogate these traits extensively.
