...
## Relational Turing Machine
**Concept:** Modeled a Turing Machine purely using relational algebra. The tape, head state, and transition table are relations. State evaluation and movement are executed via Joins, Extensions, and Unions, simulating an infinite tape using sparse records.
**Fate:** TBD
**Lesson:** TBD
