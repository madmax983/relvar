...
## Relational Boids (Flocking)
**Concept:** Modeled a Boids flocking simulation purely using relational algebra. Boids are a relation. Cross Joins compute pairwise distances, Restrict isolates neighbors, Summarize computes Separation/Alignment/Cohesion forces, and Extend updates velocities and positions.
**Fate:** TBD
**Lesson:** TBD
