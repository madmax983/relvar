...
**Concept:** Implemented Craig Reynolds' Boids flocking algorithm using purely relational algebra. Modes separation, alignment, and cohesion as cross joins, extensions, and aggregations.
**Fate:** Merged
**Lesson:** Complex multi-agent emergent behavior can be completely declaratively specified. Cross join easily models neighbor combinations, and aggregation seamlessly sums up environmental forces!
