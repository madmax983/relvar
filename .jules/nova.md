...
**Concept:** Modeled the Apriori algorithm for frequent itemset mining purely using relational algebra. Frequent 1-itemsets and 2-itemsets are computed via relational join, extension, summarization, and restriction over transactions represented as relations.
**Fate:** Merged
**Lesson:** Relational algebra is highly effective for association rule mining! Computations like filtering candidates and counting support inherently match the join-restrict-summarize sequence of operations without needing looping traversal or complex hashing maps.
