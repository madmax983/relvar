...
**Concept:** Modeled a Decision Tree Classifier purely using relational algebra. Tree nodes and instances are relations. The tree is evaluated by joining instances with node split criteria and evaluating conditions via relational extensions until instances reach leaf nodes.
**Fate:** TBD
**Lesson:** TBD
