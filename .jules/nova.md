...
## Relational Turing Machine
**Concept:** Implemented `TuringMachine` using purely relational algebra. The tape, state, and transitions are purely relational. Evaluating a single step is entirely declarative, meaning we transition states and write to the tape using set operations without procedural looping per step component.
**Fate:** TBD
**Lesson:** TBD
