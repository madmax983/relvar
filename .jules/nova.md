...
## Relational CRDTs
**Concept:** Modeled Conflict-Free Replicated Data Types (ORSet and LWWRegister) purely using relational algebra. Merging replicas elegantly compiles down to Relational Union, while evaluation relies on Set Difference (for sets) and Summarization/Join (for registers).
**Fate:** TBD
**Lesson:** Relational sets naturally support convergent distributed systems! Commutative, associative union operations ensure eventual consistency with minimal custom code.
