...
**Concept:** Implemented a flocking simulator using purely relational algebra (Boids). Evaluates neighborhood constraints, distances, Separation, Alignment, and Cohesion purely via relational joins, restrict, extend, and summarization aggregations over a single Boids relation.
**Fate:** TBD
**Lesson:** Relational algebra is more than capable of simulating physical proximity logic! Computing local neighborhood densities maps beautifully to cross-joins and summarizations.
