...
## Relational Build System
**Concept:** Modeled a Build System (like Make/Ninja) using pure relational algebra. Dependencies are an edges relation, and file timestamps are a relation. Stale targets are resolved by finding files older than their dependencies via transitive closure (`tclose`), relational joins, unions, and difference operations.
**Fate:** Merged
**Lesson:** Relational algebra gracefully models constraint graphs and file dependency resolution declaratively!
