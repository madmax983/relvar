...
**Concept:** Modeled a Publish/Subscribe system where subscriptions and events are pure relations. Dispatching evaluates natively via a relational Natural Join on `event_type`.
**Fate:** Merged
**Lesson:** Relational joins act naturally as routing tables!
