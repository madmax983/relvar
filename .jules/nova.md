...
**Concept:** Modeled Craig Reynolds' Boids flocking simulation using purely relational algebra (Theta Join, Extend, Summarize, Project). Flocking behaviors (separation, alignment, cohesion) are evaluated as distance constraints, aggregations, and velocity projections without any procedural traversal of neighbors.
**Fate:** TBD
**Lesson:** TBD
