...
**Concept:** Modeled a Condorcet Ranked Choice Voting system using pure relational algebra. Evaluates all pairwise matchups between candidates using cross joins, scores preferences via Extension, and finds the undefeated winner via Difference.
**Fate:** TBD
**Lesson:** TBD
