...
**Concept:** Modeled a Turing Machine purely with relational algebra. Evaluated machine state and tape updates using Joins and Extensions on relations representing `transitions`, `tape` and `current` state, proving the relational model is Turing Complete!
**Fate:** TBD
**Lesson:** TBD
