...
**Concept:** Modeled a quantum circuit simulator purely using relational algebra. Quantum states are modeled as relations representing the state vector amplitudes, and applying gates translates to performing a relational tensor contraction (natural join on specific qubits, multiplied extension of amplitudes, and summarization).
**Fate:** Merged
**Lesson:** Relational engines have more than enough expressiveness to encode tensor contractions for simulating quantum states!
