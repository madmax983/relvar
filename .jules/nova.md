...
## Relational Boids Simulator
**Concept:** Modeled Craig Reynolds' Boids flocking simulation using purely relational algebra. Evaluates separation, alignment, and cohesion via Cartesian product, Restriction to finding local neighbors, Extension for vector deltas, and Summarize for averaging neighbors vectors.
**Fate:** TBD
**Lesson:** TBD
