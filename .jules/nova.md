...
**Concept:** Modeled a Boids flocking simulation (Reynolds, 1987) using purely relational algebra. Implemented cohesion, alignment, and separation rules entirely with relation self-joins, distance filters, and summarizations of neighbor velocities/positions, showing that complex emergent behavior can be completely simulated in a declarative relational paradigm.
**Fate:** TBD
**Lesson:** TBD
