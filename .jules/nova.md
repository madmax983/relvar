...
**Concept:** Modeled a Markov Decision Process (MDP) solver purely with relational algebra. Performed Value Iteration to find optimal values and extract policies by using Relational Joins, Summarizations with Sum/Max Aggregations, and Extensions.
**Fate:** TBD
**Lesson:** TBD
