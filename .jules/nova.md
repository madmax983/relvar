...
**Concept:** Modeled a quantum state and quantum logic gates purely with relational algebra. Quantum gates (like Hadamard, Pauli-X, CNOT) are represented as complex matrices in relations. Gate application uses Joins and Extensions for complex matrix multiplication, and Tensor Products for combining gates.
**Fate:** TBD
**Lesson:** Relational joins act as powerful matrix multipliers and cross joins handle tensor products elegantly, turning the relational engine into a capable quantum state simulator!
