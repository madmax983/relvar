...
## 2026-07-23 - [Vulnerable Dependencies Addressed]
**Threat:** Invalid pointer dereference in `crossbeam-epoch` (RUSTSEC-2026-0204) and unsoundness in `anyhow` (RUSTSEC-2026-0190) which could lead to Undefined Behavior.
**Defense:** Bumped versions of `crossbeam-epoch` to >=0.9.20 and `anyhow` to >=1.0.104.
