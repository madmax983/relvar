...
## 2024-01-26 - [Dependency vulnerabilities]
**Threat:** Dependencies were using vulnerable versions (`crossbeam-epoch` and `anyhow`) with potential unsoundness.
**Defense:** Updated the lockfile to bump the crates and removed vulnerabilities.
