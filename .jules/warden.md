...
## 2026-07-28 - [Upgrade vulnerable dependencies]
**Threat:** Invalid pointer dereference in crossbeam-epoch (RUSTSEC-2026-0204) and unsoundness in anyhow (RUSTSEC-2026-0190) crates allowed Undefined Behavior or security vulnerabilities.
**Defense:** Upgraded `crossbeam-epoch` to >=0.9.20 and `anyhow` to v1.0.104 in Cargo.lock to pull in secure versions.
