...
## 2026-08-20 - [Vulnerable Dependencies]
**Threat:** Invalid pointer dereference in `fmt::Pointer` impl for `Atomic` and `Shared` in `crossbeam-epoch` (RUSTSEC-2026-0204) and unsoundness in `anyhow` `Error::downcast_mut()` (RUSTSEC-2026-0190).
**Defense:** Updated `crossbeam-epoch` to v0.9.20 and `anyhow` to v1.0.104.
