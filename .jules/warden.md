...
## 2026-07-25 - [Dependency Vulnerabilities in crossbeam-epoch and anyhow]
**Threat:** The `crossbeam-epoch` crate (v0.9.18) has an invalid pointer dereference vulnerability (RUSTSEC-2026-0204) and `anyhow` (v1.0.102) has an unsoundness vulnerability (RUSTSEC-2026-0190), posing risks of Undefined Behavior.
**Defense:** Upgraded `crossbeam-epoch` to v0.9.20 and `anyhow` to v1.0.104.
