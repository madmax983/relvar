...
## 2026-07-22 - [Dependency vulnerabilities in crossbeam-epoch and anyhow]
**Threat:** Vulnerability in `crossbeam-epoch` (Invalid pointer dereference) and `anyhow` (Unsoundness).
