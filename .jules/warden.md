...
## 2024-05-18 - Upgrade dependencies with vulnerabilities
**Threat:** Invalid pointer dereference in crossbeam-epoch < 0.9.20 (RUSTSEC-2026-0204). Unsoundness in anyhow Error::downcast_mut < 1.0.103 (RUSTSEC-2026-0190).
**Defense:** Upgraded `crossbeam-epoch` to `0.9.20` and `anyhow` to `1.0.104` to resolve vulnerabilities.
