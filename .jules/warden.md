...
## 2026-08-05 - [Dependency vulnerabilities]
**Threat:** Cargo.lock contained vulnerable dependencies (`crossbeam-epoch`, `anyhow`).
**Defense:** Updated to latest compatible versions (`crossbeam-epoch v0.9.20`, `anyhow v1.0.104`).
