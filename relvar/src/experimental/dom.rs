...
impl RelationalDom {
    ...
    /// use relvar::experimental::dom::RelationalDom;
    ///
    /// let nodes = Relation::new(RelationType::new(TupleType::new().with_attribute("node_id", ScalarType::Int).with_attribute("tag", ScalarType::String)));
    /// let edges = Relation::new(RelationType::new(TupleType::new().with_attribute("parent_id", ScalarType::Int).with_attribute("child_id", ScalarType::Int)));
    /// let attributes = Relation::new(RelationType::new(TupleType::new().with_attribute("node_id", ScalarType::Int).with_attribute("attr_name", ScalarType::String).with_attribute("attr_value", ScalarType::String)));
    ///
    /// let dom = RelationalDom::new(nodes, edges, attributes);
    /// ```
    ...
    /// use relvar::experimental::dom::RelationalDom;
    ///
    /// let mut attributes = Relation::new(RelationType::new(TupleType::new()
    ///     .with_attribute("node_id", ScalarType::Int)
    ///     .with_attribute("attr_name", ScalarType::String)
    ///     .with_attribute("attr_value", ScalarType::String)));
    /// attributes.insert(tuple! { node_id: 1i64, attr_name: "class", attr_value: "container" }).unwrap();
    ///
    /// let dom = RelationalDom::new(
    ///     Relation::new(RelationType::new(TupleType::new().with_attribute("node_id", ScalarType::Int).with_attribute("tag", ScalarType::String))),
    ///     Relation::new(RelationType::new(TupleType::new().with_attribute("parent_id", ScalarType::Int).with_attribute("child_id", ScalarType::Int))),
    ///     attributes
    /// );
    ///
    ...
    ///     Relation::new(RelationType::new(TupleType::new().with_attribute("node_id", ScalarType::Int).with_attribute("tag", ScalarType::String))),
    ///     edges,
    ///     Relation::new(RelationType::new(TupleType::new().with_attribute("node_id", ScalarType::Int).with_attribute("attr_name", ScalarType::String).with_attribute("attr_value", ScalarType::String)))
    /// );
    ///
    /// let mut ancestors = Relation::new(RelationType::new(TupleType::new().with_attribute("node_id", ScalarType::Int)));
    /// ancestors.insert(tuple! { node_id: 1i64 }).unwrap();
    ///
    /// let mut targets = Relation::new(RelationType::new(TupleType::new().with_attribute("node_id", ScalarType::Int)));
    /// targets.insert(tuple! { node_id: 2i64 }).unwrap();
    ///
