...
impl PhysicsEngine {
    ...
    fn compute_pairwise_forces(&self) -> Result<Relation, DatabaseError> {
        ...
        self.calculate_pairwise_forces(&interactions)
    }
    ...
    fn calculate_pairwise_forces(
        ...
        interactions
            .extend("fx", ScalarType::Float, move |t| {
                Self::calculate_force_component(t, g, true)
            })
            .map_err(|e| DatabaseError::AlgebraError(e.to_string()))?
            .extend("fy", ScalarType::Float, move |t| {
                Self::calculate_force_component(t, g, false)
            })
            .map_err(|e| DatabaseError::AlgebraError(e.to_string()))
    }

    fn calculate_force_component(
