...
impl SudokuSolver {
    ...
    fn compute_invalid_possibilities(
        ...
        // Helper closure computing invalid possibilities for one constraint:
        // rename known's non-constraint attributes to avoid collision, then
        // join on the constraint attributes plus val.
        let compute_invalid =
