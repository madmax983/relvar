//! A Relational Spreadsheet Engine demonstrating how to model spreadsheet cells and formulas.
//!
//! This module showcases the "Spreadsheet as a Database" concept where cell evaluation
//! is treated purely as relational joins and extensions, repeating until all cell values
//! are resolved (a fixpoint).
...
impl Spreadsheet {
    ...
    /// let b1 = result.tuples().find(|t| t.get_typed::<String>("id").unwrap() == "B1").unwrap();
