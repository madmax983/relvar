//! # Spreadsheet
//!
//! A Relational Spreadsheet Engine that evaluates formulas purely using relational operations.
//! It models a spreadsheet where cells contain raw values or formulas referencing other cells.
