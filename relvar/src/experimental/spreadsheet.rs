...
///
/// // Create values schema: (id: String, val: Float)
...
///
/// // Create formulas schema: (id: String, op: String, arg1: String, arg2: String)
...
impl Spreadsheet {
    ...
    ///
    /// // The result now includes the evaluated formula cell B1 = 30.0
