...
impl Spreadsheet {
    ...
    ///
    /// ```
    /// use relvar_core::{Relation, types::{RelationType, ScalarType, TupleType}, tuple};
    ...
    /// formulas.insert(tuple! { id: "B1".to_string(), op: "ADD".to_string(), arg1: "A1".to_string(), arg2: "A1".to_string() }).unwrap();
    ///
    /// let spreadsheet = Spreadsheet::new(values, formulas);
