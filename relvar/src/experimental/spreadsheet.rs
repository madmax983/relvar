...
//!
//! This module provides a way to model a spreadsheet entirely using relational algebra.
//! Cells can contain raw values or formulas referencing other cells. The evaluation
//! process iteratively applies relational joins and extensions to resolve formulas
