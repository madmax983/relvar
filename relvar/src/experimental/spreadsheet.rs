...
///
/// ```
/// use relvar_core::{Relation, tuple};
/// use relvar_core::types::{RelationType, ScalarType, TupleType};
/// use relvar::experimental::spreadsheet::Spreadsheet;
///
/// // Setup schemas for our spreadsheet
...
/// }).unwrap();
///
/// // Create and evaluate the spreadsheet
...
impl Spreadsheet {
    /// Creates a new Spreadsheet engine from a set of initial values and formulas.
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// let result = spreadsheet.evaluate().unwrap();
    ///
    /// // The resulting relation contains the original values plus the evaluated formulas
    /// assert_eq!(result.cardinality(), 3);
    /// ```
