...
///
/// ```
/// use relvar_core::{tuple, types::{RelationType, ScalarType, TupleType}, values::Relation};
...
///
/// // Initial values: A1 = 10.0, A2 = 20.0
...
impl Spreadsheet {
    ...
    ///
    /// assert_eq!(evaluated.cardinality(), 3); // A1, A2, and B1 (which is 30.0)
    /// ```
