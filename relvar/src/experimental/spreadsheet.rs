...
///
/// ```
/// use relvar_core::{tuple, types::{RelationType, TupleType, ScalarType}, values::Relation};
...
impl Spreadsheet {
    ...
    ///
    /// ```
    /// use relvar_core::{types::{RelationType, TupleType, ScalarType}, values::Relation};
    /// use relvar::experimental::spreadsheet::Spreadsheet;
    ///
    /// let val_heading = TupleType::new()
    ///     .with_attribute("id", ScalarType::String)
    ...
    /// values.insert(tuple! { id: "A2".to_string(), val: 15.0f64 }).unwrap();
    ///
    /// let form_heading = TupleType::new()
    ///     .with_attribute("id", ScalarType::String)
    ///     .with_attribute("op", ScalarType::String)
